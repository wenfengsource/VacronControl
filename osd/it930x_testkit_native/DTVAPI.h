...
#define DTVAPI_VERSION 0x16020201
#define _GNU_SOURCE
...
//		0 if no error, non-zero value otherwise.
//-----------------------------------------------------------------------------
DTVEXPORT Dword DTV_NULLPacket_Filter(
	IN int handle,
...
//-----------------------------------------------------------------------------
//	PURPOSE:
//		Get Endeavour Board ID Value.
//
//	PARAMETERS:
//		handle
//		pValue		- pointer of  Board ID value.
// 
//	RETURNS:
//		0 if no error, non-zero value otherwise.
// -----------------------------------------------------------------------------
DTVEXPORT Dword DTV_Endeavour_GetBoardID(
	IN int handle,
	OUT Byte *pValue);
	
//-----------------------------------------------------------------------------
//	PURPOSE:
//		Get Dibcom detail channel information.
//
//	PARAMETERS:
//		handle
//		pValue		- pointer of Dibcom.
// 
//	RETURNS:
//		0 if no error, non-zero value otherwise.
// -----------------------------------------------------------------------------
DTVEXPORT Dword DTV_Endeavour_Dibcom_Detail_Channel_Info(
		IN int handle,
